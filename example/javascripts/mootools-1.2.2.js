...
}else{Log.logged.push(arguments);}};Array.implement({min:function(){return Math.min.apply(null,this);},max:function(){return Math.max.apply(null,this);
...
$each(c,function(f,e){d=d.replace(new RegExp(e,"g"),f);});return d;}});})();